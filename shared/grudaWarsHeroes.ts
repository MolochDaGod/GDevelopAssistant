...
const HERO_DEFINITIONS: Omit<GrudaWarsHero, "gdaType" | "gdaRarity" | "gdaBaseStats">[] = [
  ...
  },
  {
    ...
    description: "A master of stealth and precision strikes, Kael eliminates targets before they know he's there.",
    lore: "Trained in the hidden arts of the Shadow Covenant, Kael has honed his skills to perfection. His blades strike from darkness, and his targets rarely get a second chance to react.",
    raceId: "human",
    classId: "rogue",
    level: 5,
    wcsAttributes: {
    ...
    playstyle: "Agile Melee DPS - High crits, evasion, burst damage",
  ...
  },
  {
    ...
    playstyle: "Support/Healer - Sustain team, buff allies, light offense",
